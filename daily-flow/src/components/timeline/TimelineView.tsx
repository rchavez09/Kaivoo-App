...
import {
  startOfMonth, endOfMonth, addDays, subDays, eachDayOfInterval,
  differenceInDays,
} from 'date-fns';
  ...
  if (datedProjects.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <h3 className="text-lg font-medium text-foreground mb-1">No projects with dates</h3>
    ...
    <div className="border border-border rounded-xl overflow-hidden bg-card">
      ...
      >
        <div style={{ minWidth: totalWidth }}>
          ...
          <div className="flex">
            {/* Label column header */}
            <div className="sticky left-0 z-20 bg-background border-b border-r border-border" style={{ width: LABEL_WIDTH }}>
              <div className="h-[52px] flex items-end px-3 pb-1">
