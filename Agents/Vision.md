...
**Active sprint:** None (planning Sprint 29)
**Last completed:** Sprint 28 (Launch Ready) — Landing page built with Astro + Tailwind (11 sections, dark/light toggle, responsive). Deployed to Netlify (kaivoo-landing). EULA and Privacy Policy attorney-ready drafts. Product Hunt listing draft. Revenue pipeline (signing keys, Stripe, Edge Functions) deferred — user wants to add more features before going live. 6/6 active parcels done. See `Sprints/Sprint-28-Launch-Ready.md`.
