...
Own your AI's memory. Own your workflow. Pay once.
...
- **Soul File** — Your AI's memory is a readable, editable, exportable file you own. Not a black box on someone else's server.
- **BYO API keys** — Plug in OpenAI, Claude, Gemini, Groq, Mistral, DeepSeek, OpenRouter, or run fully local with Ollama. You pay the provider directly.
- **Local-first** — Everything stored in a local SQLite database. Zero telemetry. Zero analytics. Works 100% offline.
- **Knowledge vault** — Nested topics, wiki-style pages, file attachments. Export as Obsidian-compatible markdown.
- **Routines and insights** — Habit tracking with streaks, weekly analytics, and a GitHub-style activity heatmap.

**Pricing:** $49 one-time for founding members. $99 standard. No subscription. One year of updates included. 30-day money-back guarantee.
...
1. Hero screenshot — light mode (daily planner overview)
2. Hero screenshot — dark mode (Abyss theme)
3. Soul File settings — light mode
4. Soul File settings — dark mode
5. *(Future: AI concierge conversation)*
6. *(Future: Knowledge vault / topic tree)*
...
- [ ] Upload 4 screenshots (have light + dark for hero and soul file)
- [ ] Record a short demo GIF or video (optional but high-impact)
- [ ] Schedule launch day (Tuesday-Thursday typically best)
- [ ] Prepare social media cross-posts (Twitter/X, LinkedIn, Reddit)
- [ ] Line up 5-10 early supporters to comment and upvote at launch
- [ ] Set up a "coming soon" or waitlist if product isn't ready for purchase yet
