# Agent 6: Usability Architect — Kaivoo Hub Feature & Experience Design
## Personal Productivity OS · Usability Specification v1.0

**Role:** Usability Architect
**Mission:** Transform research findings, user pain points, and product vision into concrete use cases, user flows, interaction patterns, and feature specifications that make Kaivoo Hub feel like the productivity tool people have been waiting for — one that anticipates how users actually work rather than forcing them into rigid workflows.

**Date:** February 2026
**Status:** ACTIVE — Ongoing design mandate
**Depends on:** Research Analyst (Agent 5) for validated findings
**Feeds into:** Senior UI Designer (Agent 1), Staff Software Engineer (Agent 2), System Architect (Agent 3)
...
3. [Use Case 1: Unified Day View](#3-use-case-1-unified-day-view)
4. [Use Case 2: Journal Time Travel](#4-use-case-2-journal-time-travel)
5. [Use Case 3: Calendar Source Aggregation](#5-use-case-3-calendar-source-aggregation)
6. [Use Case 4: Retroactive Routine Completion](#6-use-case-4-retroactive-routine-completion)
7. [Use Case 5: Insight Zoom Levels](#7-use-case-5-insight-zoom-levels)
8. [Use Case 6: Cross-Entity Day Drilling](#8-use-case-6-cross-entity-day-drilling)
9. [Use Case 7: Drop File → Get Insights](#9-use-case-7-drop-file--get-insights)
10. [Use Case 8: Connected Context](#10-use-case-8-connected-context)
11. [Use Case 9: Mood Tracking](#11-use-case-9-mood-tracking)
12. [Use Case 10: Daily Shutdown Ritual](#12-use-case-10-daily-shutdown-ritual)
13. [Use Case 11: Automated Correlation Discovery](#13-use-case-11-automated-correlation-discovery)
14. [Use Case Prioritization](#14-use-case-prioritization)
15. [Interaction Patterns Library](#15-interaction-patterns-library)
...
The Usability Architect sits between research and implementation. It takes validated pain points from the Research Analyst (Agent 5) and translates them into use cases, user stories, and interaction specifications that are concrete enough for the UI Designer (Agent 1) to wireframe and the Engineer (Agent 2) to build.

This agent thinks in **scenarios**, not features. A feature is "add Google Calendar sync." A scenario is "Sarah is on her phone at 8am, opens Kaivoo, and instantly sees her meetings for the day alongside the routines she wants to complete and the tasks she committed to yesterday — without opening three different apps."

## 1.2 Core Philosophy

```
1. THE DAY IS THE ATOMIC UNIT
   People think in days, not databases. Every interaction in Kaivoo
   should be answerable by: "What day does this belong to?"
   A task has a due date. A journal entry has a date. A meeting has
   a date. A routine completion has a date. The day is the thread
   that connects everything.

2. EVERY VIEW IS AN ENTRY POINT
   Users shouldn't need to navigate "to the right page" to do
   something. See a routine in Day Review? Toggle it right there.
   See a journal entry in the calendar? Edit it right there.
   See a task on the Insights page? Mark it done right there.

3. INFORMATION SHOULD FLOW TO YOU
   Don't make users hunt for context. If they're looking at
   Tuesday, show them everything about Tuesday — automatically.
   Meetings, tasks due, tasks completed, journal entries, routines,
   captures. One glance.

4. PAST DAYS ARE NOT READ-ONLY MUSEUMS
   Life is messy. People forget to check things off. People want
   to add notes to yesterday. People realize a routine was done
   but not recorded. The app should accommodate this gracefully,
   not punish it.

5. INSIGHTS SHOULD REVEAL WHAT YOU CAN'T SEE YOURSELF
   A list of "tasks completed this week" is not an insight.
   An insight is: "You've journaled 12 days straight — your
   longest streak." Or: "You complete 40% more tasks on days
   you do your morning routine." Connect the dots the user can't.
```
...
## 2.1 The "Day Gravity" Principle

Everything in Kaivoo Hub has a gravitational pull toward a day. This means:

- **Tasks** → due date or completion date
- **Journal entries** → entry date
- **Meetings** → meeting date
- **Routine completions** → completion date
- **Captures** → capture date
- **Files** → modified date (secondary: created date)

Any date you click, anywhere in the app, should be able to pull up the full context for that day.

## 2.2 The "Edit Where You See It" Principle

If you can see a piece of data, you should be able to interact with it:

| If you see... | You should be able to... |
|---------------|--------------------------|
| A routine in Day Review | Toggle it completed/incomplete |
| A journal entry in the calendar sidebar | Click to edit it |
| A task in the calendar day view | Mark it done, change priority |
| A meeting in any view | Add notes, see attendees, join link |
| An insight about routine streaks | Click through to the routine |

## 2.3 The "Progressive Disclosure" Principle

Don't overwhelm. Show summaries first, details on demand:

```
LEVEL 1: Glanceable
  "3 meetings, 5 tasks, 2 journal entries, 80% routines"

LEVEL 2: Scannable
  Meeting list, task titles, entry previews, routine chips

LEVEL 3: Full Detail
  Expanded meeting with notes, full journal entry in editor,
  task with subtasks and description, routine history
```

---

# 3. Use Case 1: Unified Day View
...
## 3.3 Proposed Solution: The Day Timeline
...
# 4. Use Case 2: Journal Time Travel
...
# 5. Use Case 3: Calendar Source Aggregation
...
## 5.4 Calendar Display with Sources
...
# 6. Use Case 4: Retroactive Routine Completion
...
## 6.4 Where Retroactive Toggle Appears
...
# 7. Use Case 5: Insight Zoom Levels
...
## 7.3 Proposed Solution: Multi-Scale Insights
...
## 7.4 Key Interaction: Drill-Down
...
# 8. Use Case 6: Cross-Entity Day Drilling
...
## 8.3 Proposed Solution: The Date Chip
...
# 9. Use Case 7: Drop File → Get Insights (Phase 4+)
...
## 9.3 Proposed Solution: The Insight Pipeline
...
## 9.5 NotebookLM-Style Integration (Future)
...
# 10. Use Case 8: Connected Context
...
## 10.3 Proposed Solution: Implicit Connections via Day
...
## 11.3 Proposed Solution: One-Tap Mood Selector
...
# 12. Use Case 10: Daily Shutdown Ritual
...
## 12.3 Proposed Solution: 4-Step Shutdown Flow
...
# 13. Use Case 11: Automated Correlation Discovery
...
## 13.3 Proposed Solution: Nightly Correlation Engine
...
## 13.4 Where Correlations Appear
...
> **Use Case Prioritization:** See [Agent-6-Docs/Use-Case-Prioritization-Sprint-0.md](Agent-6-Docs/Use-Case-Prioritization-Sprint-0.md) for sprint/phase scheduling of use cases. The Director incorporates this into sprint planning.

---

# 14. Interaction Patterns Library

## 15.1 The Inline Toggle
...
```
❌ DON'T: Force users to "go to the right page" to do something
   DO: Let them act on data wherever they see it

❌ DON'T: Make past data read-only with no escape hatch
   DO: Allow retroactive edits with appropriate guardrails

❌ DON'T: Show data without context (e.g., a task with no date context)
   DO: Always show when something happened or is due

❌ DON'T: Build complex explicit linking systems ("link this meeting to this task")
...
**Agent 6: Usability Architect — v1.1**
**February 2026**

*v1.0: 8 use cases + prioritization matrix*
*v1.1: Added UC9 (Mood Tracking), UC10 (Daily Shutdown), UC11 (Correlation Discovery). Updated prioritization to 3-sprint structure. Answered 6 of 7 open questions from research findings.*

*Design for how people actually work, not how they say they work.*
